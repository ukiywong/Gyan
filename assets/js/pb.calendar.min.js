jQuery(function (a) {
   ...
   b.prototype.yyyymm = function (a) {
      ...
      return a.isFunction(this._options.schedule_list) ? void this._options.schedule_list.apply(this, [a.proxy(function (a) {
         ...
         module: this,
         callback: b
      }), this._yyyy_mm_moment]) : void b.apply(this, [this._options.schedule_list])
      ...
      var b = this._yyyy_mm_moment,
         c = parseInt(b.format("YYYYMM")),
         d = b.clone();
      d.date(1);
      var e = b.clone();
      ...
      for (var f = e.diff(d, "days"), g = d.clone(), h = 0, i = "", j = 0; j <= f; ++j) {
         ...
         var k = parseInt(g.format("YYYYMM")),
            l = g.format("E"),
            m = 6 == l || 7 == l,
            n = "";
      ...
      this._body_frame.html(i), this._schedule_list(function (b) {
         ...
         var c = a(b.currentTarget),
            d = c.attr("data-selectable-day-yyyymmdd");
